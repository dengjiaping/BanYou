...
import com.net.tsz.afinal.db.table.Id;
import com.net.tsz.afinal.db.table.Index;
import com.net.tsz.afinal.db.table.KeyValue;
import com.net.tsz.afinal.db.table.ManyToOne;
import com.net.tsz.afinal.db.table.Property;
...
public class SqlBuilder {
	...
	public static String getIndexSQL(Class<?> clazz){
		TableInfo table=TableInfo.get(clazz);
		StringBuffer strSQL = new StringBuffer();
		if(table.IndexMap.size()>0){
			
			strSQL.append("CREATE index "+table.getTableName()+"_index"+" on ");
			strSQL.append(table.getTableName());
			strSQL.append(" ( ");
			//table1(col1,col2,col3)   
			
			Collection<Index> propertys = table.IndexMap.values();
			for(Property property : propertys){

 ...
 */
package com.net.tsz.afinal.http;
...
import com.net.tsz.afinal.core.AsyncTask;
import com.net.tsz.afinal.http.entityhandler.EntityCallBack;
import com.net.tsz.afinal.http.entityhandler.FileEntityHandler;
import com.net.tsz.afinal.http.entityhandler.StringEntityHandler;
...
public class HttpHandler<T> extends AsyncTask<Object, Object, Object> implements
	...
	protected void onProgressUpdate(Object... values) {
		...
		case UPDATE_FAILURE:
			...
			break;
		case UPDATE_SUCCESS:
			Log.i("json:", String.valueOf(values[1]));
			if (callback != null){

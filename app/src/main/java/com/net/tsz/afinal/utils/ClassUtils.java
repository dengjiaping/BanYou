 ...
 */
package com.net.tsz.afinal.utils;
...
import com.net.tsz.afinal.db.sqlite.ManyToOneLazyLoader;
...
public class ClassUtils {
	...
	public static List<Index> getIndexList(Class<?> clazz) {

		List<Index> plist = new ArrayList<Index>();
		try {
			Field[] fs = clazz.getDeclaredFields();
			for (Field f : fs) {
				if (!FieldUtils.isTransient(f) && FieldUtils.isIndex(f)) {

					Index property = new Index();

...
import com.net.tsz.afinal.http.HttpHandler;
import com.net.tsz.afinal.http.RetryHandler;
import com.net.tsz.afinal.http.SyncRequestHandler;
...
public class FinalHttp {
    ...
    */
    ...
    public void post(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
    	if(params!=null)
    	Log.i("FinalHttp", params.getParamString());

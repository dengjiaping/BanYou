...
import com.quanliren.quan_one.custom.CustomDialog.Builder;
...
public class IosCustomDialog extends Dialog {
    ...
    public IosCustomDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        IosCustomDialog dialog;
        /**
         * Create the custom dialog
         */
        public IosCustomDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            dialog = new IosCustomDialog(context, R.style.dialog);

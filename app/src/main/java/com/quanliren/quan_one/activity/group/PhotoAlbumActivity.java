...
import com.quanliren.quan_one.adapter.PhotoAibumAdapter;
...
public class PhotoAlbumActivity extends MenuFragmentBase{
	@ViewInject(id=R.id.album_gridview) ListView aibumGV;
	...
	public View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, Bundle savedInstanceState) {
		View view=inflater.inflate(R.layout.activity_photoalbum, null);

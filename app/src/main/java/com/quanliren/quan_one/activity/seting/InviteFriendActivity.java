...
public class InviteFriendActivity extends BaseActivity implements
	...
	public static final String APP_ID = "101071166"; // qq
//	public static final String WEIXIN_ID = "wx488920a29404152c";// 微信
	public static final String WEIXIN_ID = "wx6c2d76893b5a5a67";// 微信
	Tencent mTencent;
	QQAuth mQQAuth;
	...
	@ViewInject(id = R.id.fx_sina_btn, click = "shareToSina")
	View fx_sina_btn;
	@ViewInject(id = R.id.fx_qq_btn, click = "shareToQQ")
	View fx_qq_btn;
	@ViewInject(id = R.id.fx_msg_btn, click = "shareToMsg")
	View fx_msg_btn;
	@ViewInject(id = R.id.fx_weixin_btn, click = "shareToWeiXin")
	View fx_weixin_btn;
	@ViewInject(id = R.id.fx_friend_btn, click = "shareToWeiXin")
	View fx_friend_btn;
...
//	http://www.bjqlr.com/c.php
	String content = "伴游是一款基于地理位置的移动社交 App软件无论你身处何地用伴游，你可以轻松找到陪你游玩的人秘又浪漫的旅行吧。下载地址："+url;
	File f;
	File ficon;
	/** 微博 Web 授权类，提供登陆等功能 */

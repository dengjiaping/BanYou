...
import com.quanliren.quan_one.adapter.AreaAdapter;
...
public class ChosePositionFragment extends Fragment{
	...
	@ViewInject(id=R.id.edittext)EditText input;
	@ViewInject(id=R.id.position_list)ListView listview;
	@ViewInject(id=R.id.now_position)TextView now_position;
	@ViewInject(id=R.id.layoutindex)LinearLayout layoutIndex;
	@ViewInject(id=R.id.title_bar)TextView title_bar;
